...
export const MainSystem = () => {
  ...
  // Efecto de transición al cambiar de vista
  useEffect(() => {
    setIsSyncing(true);
    setGlitch(true);
  ...
  return (
    ...
    `}>
      ...
      {/* CAPAS DE ATMÓSFERA (siempre al fondo) */}
      ...
      <header className={styles.hudTop}>
        <div className={styles.hudTopLeft}>
          <div className={styles.sysBranding}>
            ...
            <span className={styles.verTag}>v.9.4.1</span>
          </div>
          <NodeSearch />
        </div>
...
// Componente interno PanelHeader (sin cambios)
