...
export default function ArasakaSidebarLeft() {
  ...
  const metrics = useMemo(() => {
    ...
    const securityNodes =
      nodes?.filter((n) => n.type === "security").length || 0;

    const potentialFlows =
      totalNodes > 0 ? Math.floor(totalNodes * 1.5) : 0;
          ...
          {!leftCollapsed ? (
            ...
            >
              ...
              <h2 className={styles.brandText}>
                ARASAKA
                <span className={styles.brandAccent}>.NET</span>
              </h2>
      ...
      <footer className={styles.footer}>
        ...
        {!leftCollapsed ? (
          ...
          <div className={styles.miniFooter}>
            ...
            <span className={styles.verticalMetric}>
              {metrics.rootLoad}
            </span>
